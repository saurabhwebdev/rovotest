...
export default function CreateRegisterTemplatePage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await addDoc(collection(db, 'registerTemplates'), template);
      
      // Redirect to the register management page
      router.push('/admin/register-management');
      
    } catch (error) {
      console.error('Error creating register template:', error);
      setFormErrors({submit: 'An error occurred while creating the register template'});
    } finally {
      setSubmitting(false);
    }
  };
  ...
  return (
    <PagePermissionWrapper pageId="admin-register-create">
      <div className="container mx-auto px-4 py-8">
        <div className="flex justify-between items-center mb-6">
          <h1 className="text-2xl font-bold">Create Register Template</h1>
          <Link
        ...
        <form onSubmit={handleSubmit}>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            {/* Field Configuration */}
            <Card className="p-6">
              <h2 className="text-xl font-semibold mb-4">Field Configuration</h2>
          ...
          <Card className="p-6 mt-6">
            <h2 className="text-xl font-semibold mb-4">Fields Preview</h2>
          ...
          <div className="mt-6 flex justify-end">
            ...
            >
              {submitting ? 'Creating...' : 'Create Register Template'}
            </button>
          </div>
        </form>
      </div>
